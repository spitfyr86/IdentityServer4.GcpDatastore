...
{
    [Kind("Client")]
    public class Client : LongIdDatastoreEntity
    {
        /// <summary>
        ...
        /// </summary>
        public int RefreshTokenUsage { get; set; } = (int)global::IdentityServer4.Models.TokenUsage.OneTimeOnly;
        ...
        /// </summary>
        public int AccessTokenType { get; set; } = (int)global::IdentityServer4.Models.AccessTokenType.Jwt;
