...
{
    [Kind("ApiResource")]
    public class ApiResourceBase : LongIdDatastoreEntity
    {
        public ApiResourceBase()
        {
        }

        public ApiResourceBase(string name, string displayName, IEnumerable<string> claimTypes)
        {
            Name = name;
